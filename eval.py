...
def eval(): 
    ...
    with tf.Session() as sess:
        print("logdire new version", hp.logdir2)
        saver.restore(sess, tf.train.latest_checkpoint(hp.logdir2)); print("Restored!")

        writer = tf.summary.FileWriter(hp.logdir2, sess.graph)
